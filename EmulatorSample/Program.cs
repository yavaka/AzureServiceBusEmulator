#:package Azure.Messaging.ServiceBus@7.20.1
using Azure.Messaging.ServiceBus;
using System.Text;

internal class Program
{
    private static string _connectionString = "Endpoint=sb://localhost;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=SAS_KEY_VALUE;UseDevelopmentEmulator=true;";
